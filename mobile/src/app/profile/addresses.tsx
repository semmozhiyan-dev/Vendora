...
const styles = StyleSheet.create({
  ...
  heading: { fontSize: FontSize["2xl"], fontWeight: "800", color: Colors.light.textHeading },
  addBtn: {
  ...
  addBtnText: { color: Colors.light.primary, fontSize: FontSize.sm, fontWeight: "700" },
  ...
  addressName: { fontSize: FontSize.base, fontWeight: "700", color: Colors.light.textHeading },
  defaultBadge: {
  ...
  defaultBadgeText: { fontSize: FontSize.xs, fontWeight: "700", color: Colors.light.accent, letterSpacing: 0.5 },
  ...
  actionLink: { fontSize: FontSize.sm, fontWeight: "700", color: Colors.light.accent },
  ...
  formTitle: { fontSize: FontSize.base, fontWeight: "700", color: Colors.light.textHeading, marginBottom: Spacing.four },
  ...
  switchLabel: { fontSize: FontSize.sm, color: Colors.light.textHeading },
  formActions: {
    flexDirection: "row",
  ...
  saveBtnText: { color: Colors.light.primary, fontSize: FontSize.sm, fontWeight: "700" },
})
