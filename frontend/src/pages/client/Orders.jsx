            ...
            <div className="mb-8 rounded-[32px] border border-gray-200 bg-white px-6 py-8 shadow-sm sm:mb-10 sm:px-8">
              <div className="flex flex-col gap-6 lg:flex-row lg:items-end lg:justify-between">
                ...
                <div className="grid gap-3 sm:grid-cols-3 lg:min-w-[420px]">
                  ...
                  <div className="rounded-[24px] border border-gray-200 bg-[#FAFAFA] px-4 py-4">
                    <p className="text-xs font-semibold uppercase tracking-[0.22em] text-gray-500">Status</p>
              ...
              <div className="space-y-4">
                  <div>
                    ...
                    className="group cursor-pointer rounded-[28px] border border-gray-200 bg-white p-5 shadow-sm transition-all duration-200 hover:-translate-y-0.5 hover:border-gray-300 hover:shadow-lg sm:p-6"
                    ...
                    <div className="mt-5 grid gap-3 border-t border-gray-100 pt-5 sm:grid-cols-3">
                      <div className="rounded-[22px] bg-[#FAFAFA] px-4 py-3">
                        ...
                        <p className="mt-1 font-mono text-base font-bold text-[#0A0A0A]">
